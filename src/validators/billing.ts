...
export const createBillingSchema = z.object({
    ...
    patientTaxId:        z.string().min(11, "CPF/CNPJ inválido").max(18, "CPF/CNPJ inválido"),
    ...
    methods:             z.array(z.enum(["PIX", "CARD"])).min(1, "Selecione ao menos um método de pagamento"),
