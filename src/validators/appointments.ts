...
export const rescheduleAppointmentSchema = z.object({
    newDate: z.string().datetime({ message: "Data inválida — use ISO 8601 com timezone (ex: ...Z)" }),
})
...
export type FetchAppointmentsQuery                     = z.infer<typeof fetchAppointmentsQuerySchema>
export type FetchAppointmentsByPsychologistQuery       = z.infer<typeof fetchAppointmentsByPsychologistQuerySchema>
