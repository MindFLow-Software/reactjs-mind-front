...
export const patientSchema = z.object({
  ...
  email: z.email('E-mail inválido').min(1, 'Email é obrigatório'),
  dateOfBirth: z
    .date()
    .nullable()
    .optional()
...
export type GetPatientDetailsQuery = z.infer<
  typeof getPatientDetailsQuerySchema
>
export type NewPatientsStatsQuery = z.infer<typeof newPatientsStatsQuerySchema>
export type RegisterPatientViaInviteData = z.infer<
  typeof registerPatientViaInviteSchema
>
