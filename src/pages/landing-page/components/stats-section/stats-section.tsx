...
import { StatCard, type StatCardData } from '../stat-card/stat-card'
      ...
      <div className="container relative z-10 mx-auto px-6 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <div className="flex flex-col">
            <SectionHeading
              badge={{ icon: TrendingUp, label: 'Resultados comprovados' }}
              heading={{
              ...
              subtitle={{
                ...
                content:
                  'Reduza a burocracia, aumente o faturamento e entregue uma experiência de alto nível para cada paciente — com muito menos esforço.',
              }}
            />
