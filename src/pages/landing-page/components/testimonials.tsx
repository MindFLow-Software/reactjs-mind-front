  ...
  return (
    <div className="mx-2 flex h-full w-[320px] flex-shrink-0 flex-col rounded-2xl border border-slate-100 bg-white p-5 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
      ...
      <div className="flex items-center gap-3 pt-4 border-t border-slate-50">
        ...
        />
        <div>
          <p className="text-[13px] font-semibold text-slate-800 leading-none mb-[4px]">
            {data.name}
          </p>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 80% 10%, rgba(37,99,235,0.07) 0%, transparent 65%)',
        }}
      />
      ...
      <div className="container relative z-10 mx-auto mb-14 px-6 text-center md:px-8 lg:px-12">
        ...
        >
          Veja relatos de psicólogos que simplificaram a gestão do consultório e
          ganharam mais tempo para seus pacientes.
        </motion.p>
      </div>
      ...
      >
        ...
        <div className="flex overflow-hidden">
          ...
          <div
            className="flex animate-marquee min-w-full shrink-0 gap-4"
            aria-hidden
          >
            {[...TESTIMONIALS, ...TESTIMONIALS].map((t, i) => (
        ...
        <div className="flex overflow-hidden">
          ...
          <div
            className="flex animate-marquee-rev min-w-full shrink-0 gap-4"
            aria-hidden
          >
            {[...row2, ...row2].map((t, i) => (
