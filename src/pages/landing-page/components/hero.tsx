            ...
            <div className="flex-1 px-5 py-4 overflow-hidden">
              ...
              <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
                ...
                {APPOINTMENTS.map(({ name, time, abord, confirmed }) => (
                  <div
                    key={name}
                    className="flex items-center justify-between px-4 py-2.5 border-b border-slate-50/80 last:border-0 hover:bg-blue-50/20 transition-colors"
                  >
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6">
            ...
            <div className="flex">
              {AVATARS.slice(0, 3).map((url, i) => (
                <img
                  ...
                  height={26}
                  loading="lazy"
                  className="w-[26px] h-[26px] rounded-full border-2 border-white object-cover -ml-2 first:ml-0"
                  alt=""
                />
              ))}
            </div>
          ...
          >
            ...
            >
              ...
              <motion.span
                ...
                style={{
                  background: `linear-gradient(90deg, rgba(37,99,235,0.25), rgba(59,130,246,0.1))`,
                }}
              />
            </span>{' '}
        ...
        >
          ...
          {PLATFORMS.map((p) => (
            <span
              key={p}
              className="text-[10px] font-semibold uppercase tracking-wide bg-white border border-slate-200/80 text-slate-400 px-2.5 py-[3px] rounded-full shadow-sm"
            >
              {p}
            </span>
          ))}
        ...
        >
          {['14 dias grátis', 'Sem cartão de crédito', 'LGPD compliant'].map(
            (item) => (
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to top, #F7F9FF 0%, transparent 100%)',
            }}
          />
        </motion.div>
      </div>
