      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        ...
        <div className="mb-14 flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
          ...
          <p className="max-w-md text-base font-light leading-relaxed text-[#4B6080]">
            Centralize as operações da sua clínica com uma suíte completa. Nossa
            tecnologia une prontuários, telemedicina e automação para garantir
            que seu consultório evolua.
          </p>
        </div>
          ...
          {solutions.map((s, i) => (
            ...
            >
              ...
              <div className="relative flex h-56 items-center justify-center overflow-hidden">
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${s.glowClass} opacity-0 transition-opacity duration-500 group-hover:opacity-100`}
                />
                <div
                ...
                >
                  <s.icon
                    className={`h-10 w-10 ${s.iconColor} transition-transform duration-300 group-hover:scale-110`}
                    strokeWidth={1.8}
                  />
                </div>
              </div>
              ...
              <div className="flex flex-1 flex-col border-t border-blue-600/08 p-7">
                ...
                <p className="text-sm font-light leading-relaxed text-[#4B6080]">
                  {s.description}
                </p>
              </div>
            </motion.div>
