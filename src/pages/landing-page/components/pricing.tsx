    ...
    <section className="py-24 lg:py-32 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <h2
            className="text-4xl lg:text-5xl font-medium tracking-tight text-slate-900 mb-6"
        ...
        <div className="flex justify-center mb-16">
          <div className="inline-flex bg-white border border-blue-200 rounded-full p-1 shadow-sm">
            <button className="relative px-4 py-2 text-sm font-medium rounded-full transition-all bg-blue-600 text-white shadow-md">
              Mensal
            </button>
            <button className="px-4 py-2 text-sm font-medium text-[#4B6080] hover:text-slate-900 transition-colors">
              Anual (20% off)
            </button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <h3
                className="text-2xl font-semibold text-slate-900 mb-4 text-center"
                style={{ fontFamily: "'Lora', serif" }}
              >
                {plan.name}
              </h3>
              <div className="text-center mb-8">
                ...
                <div className="text-sm text-[#4B6080]">
                  {plan.popular ? `/ ${plan.periodAnnual}` : `/ ${plan.period}`}
                </div>
              </div>
              ...
              <button
                className={`w-full py-4 px-6 rounded-2xl font-medium text-sm uppercase tracking-wide transition-all ${plan.popular ? 'bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-xl hover:-translate-y-1' : 'border border-slate-200 hover:border-blue-300 hover:bg-blue-50 text-slate-900 shadow-sm'}`}
              >
                Escolher {plan.name}
              </button>
            </motion.div>
