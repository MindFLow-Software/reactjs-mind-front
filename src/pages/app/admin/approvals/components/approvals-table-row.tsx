...
import {
  approvePsychologist,
  rejectPsychologist,
} from '@/api/psychologists/approvals' // Importado reject
...
export function ApprovalsTableRow({ psychologist }: { psychologist: any }) {
  ...
  const birthDate = psychologist.dateOfBirth
    ? new Date(psychologist.dateOfBirth)
    : null
      ...
      <TableCell>
        <div className="flex items-center gap-3">
          <Avatar className="h-10 w-10 ring-2 ring-background shadow-sm">
            <AvatarImage
              src={psychologist.profileImageUrl || '/placeholder.svg'}
            />
