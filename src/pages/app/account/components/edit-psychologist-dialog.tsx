...
import {
  updatePsychologist,
  type UpdatePsychologistBody,
} from '@/api/psychologists/update-psychologist'
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 py-4">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label className={cn(errors.firstName && 'text-red-500')}>
                Nome *
              </Label>
              <Input
                name="firstName"
                defaultValue={psychologist.firstName}
                className={cn(
                  'bg-secondary/30',
            ...
            <div className="space-y-2">
              <Label className={cn(errors.lastName && 'text-red-500')}>
                Sobrenome *
              </Label>
              <Input
                name="lastName"
                defaultValue={psychologist.lastName}
                className={cn(
                  'bg-secondary/30',
        ...
        <div className="flex items-center justify-end gap-3 pt-6 border-t border-muted/40">
          ...
          <Button
            type="submit"
            disabled={isPending}
            className="cursor-pointer bg-blue-600 hover:bg-blue-700 shadow-md px-8"
          >
            {isPending ? (
              <>
