...
import { PracticeContextListItem } from '../practice-context-list-item/practice-context-list-item'

type IPracticeContextAllViewActions = {
  onEnter: (id: string) => void
  onViewMain: () => void
  onAdd: () => void
}

type IPracticeContextAllView = {
  contexts: IPsychologistPracticeContext[]
  activeContextId: string | null
  actions: IPracticeContextAllViewActions
}
...
function Topbar({ contexts, onViewMain }: ITopbar) {
...
export function PracticeContextAllView({
  ...
  activeContextId,
  actions,
}: IPracticeContextAllView) {
  const { onEnter, onViewMain, onAdd } = actions
