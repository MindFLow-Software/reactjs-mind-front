...
type IPracticeContextFeaturedCardActions = {
  onEnter: (id: string) => void
  onViewAll: () => void
}

type IPracticeContextFeaturedCard = {
  context: IPsychologistPracticeContext
  otherContextsCount: number
  actions: IPracticeContextFeaturedCardActions
}
...
export function PracticeContextFeaturedCard({
  ...
  otherContextsCount,
  actions,
}: IPracticeContextFeaturedCard) {
  const { onEnter, onViewAll } = actions
  const TypeIcon =
