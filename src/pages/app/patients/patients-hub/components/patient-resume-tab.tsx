...
function StatCard({ icon: Icon, iconColor, borderColor, label, value, footer, valueClassName }: StatCardProps) {
    return (
        <Card className={cn("shadow-sm border-l-4", borderColor)}>
            <CardContent className="pt-5 pb-4">
                <p className={cn("flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-muted-foreground mb-3", iconColor)}>
                    <Icon className="h-3 w-3" />
                    {label}
                </p>
                <div className={cn("text-[28px] font-bold leading-none tabular-nums", valueClassName ?? "text-foreground")}>
                    {value}
                </div>
...
function AlertRow({ type, tag, title, description }: AlertRowProps) {
    ...
    return (
        <div className={cn("flex items-start gap-3 rounded-lg border px-3 py-2.5", s.row)}>
            <Badge className={cn("mt-0.5 shrink-0 text-[10px] font-bold px-2 h-5", s.tag)}>
                {tag}
            </Badge>
        ...
        <div className="space-y-4 mt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                <StatCard
                    ...
                    footer={
                        <div className="flex flex-wrap items-center gap-1.5">
                            <span className="text-[11px] text-muted-foreground">desde 14/10/2025</span>
                ...
                <StatCard
                    ...
                    footer={
                        <span className="text-[11px] text-muted-foreground">12 de 13 compromissos</span>
                    }
                />
                ...
                <StatCard
                    ...
                    footer={
                        <span className="text-[11px] text-muted-foreground">última em 04/04/2026</span>
                    }
                />
                ...
                <StatCard
                    ...
                    footer={
                        <span className="text-[11px] text-muted-foreground">acumulado · R$ 180/sessão</span>
                    }
                />
            </div>
                ...
                <Card className="shadow-sm">
                    <CardHeader className="pb-2">
                        <div className="flex items-start justify-between">
                            <div>
                                <CardTitle className="text-sm font-semibold">Frequência por mês</CardTitle>
                ...
                <Card className="shadow-sm">
                    <CardHeader className="pb-3">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                <CardTitle className="text-sm font-semibold">Alertas clínicos</CardTitle>
                                <CardDescription className="text-[11px]">
