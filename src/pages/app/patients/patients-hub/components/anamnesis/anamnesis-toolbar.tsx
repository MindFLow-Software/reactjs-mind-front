...
import { Bold, Italic, Underline, List, ListOrdered, Quote, MessageSquare } from "lucide-react"
...
export function AnamnesisToolbar({ onFormat, onList, saveStatus }: AnamnesisToolbarProps) {
    return (
