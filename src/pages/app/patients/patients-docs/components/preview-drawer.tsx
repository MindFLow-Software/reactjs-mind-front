...
import { FileText, Download, Trash2, Loader2, X, User, Calendar, HardDrive, FileType } from "lucide-react"
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    O arquivo <strong className="text-foreground">{filename}</strong> será removido.
