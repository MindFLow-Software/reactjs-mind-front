...
import './patients-row-actions.css'
import {
  Archive,
  CalendarPlus,
  ClipboardList,
...
import { EditPatientModal } from '../../../dialogs/edit-patient-modal/edit-patient-modal'
import { PatientDetailsDialog } from '../../../details/patient-details-dialog/patient-details-dialog'
import { usePatientStatusGuard } from '../../../../hooks/use-patient-status-guard'

type IPatientsRowActions = {
  patient: Pick<IPatient, 'id' | 'firstName' | 'lastName' | 'status'>
}

export function PatientsRowActions({ patient }: IPatientsRowActions) {
