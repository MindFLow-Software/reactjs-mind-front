...
export const RECENT_DOCUMENTS: IRecentDocument[] = [
  { id: 'doc-1', title: 'Relatório psicológico — 1º semestre', type: 'Relatório', date: '02 jun 2026' },
  { id: 'doc-2', title: 'Laudo psicológico — Avaliação inicial', type: 'Laudo', date: '18 mai 2026' },
  { id: 'doc-3', title: 'Anotação de sessão — Sessão 12', type: 'Anotação', date: '05 mai 2026' },
  { id: 'doc-4', title: 'Encaminhamento — Avaliação psiquiátrica', type: 'Encaminhamento', date: '22 abr 2026' },
  { id: 'doc-5', title: 'Termo de consentimento informado', type: 'Termo', date: '10 abr 2026' },
]
